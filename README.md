...
**Shared AWS Account**: Account information will be provided by your instructor.  When creating resources use your name prefix for the resource even if the instructions do not explicit state it.  For example, if instructions say create "Development" as resource name, prefix your name to that resource to make it unique in the account.  
